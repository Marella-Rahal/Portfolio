  ...
  return (
    <div id="about" className='px-10 pt-20 flex flex-col md:flex-row'>
        ...
        <div className='space-y-5'>
            ...
            &#128516; Graduated from the Faculty of Informatics Engineering, Department of Software Engineering , this is my second year in <span className='text-effectColor'>Front-End</span> Web Development and I just started with <span className='text-effectColor'>machine learning</span> technique.<br/>
