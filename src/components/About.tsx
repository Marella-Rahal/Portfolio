...
import LeftMotion from "./FramerMotion/LeftMotion";
import RightMotion from "./FramerMotion/RightMotion";
...
const About = () => {
  return (
    ...
    >
      <LeftMotion>
        <div className="flex flex-col items-start space-y-5">
          ...
          <p className="max-w-[90%] md:max-w-[75%]">
            ...
            <br />
            &#128516; I have the{" "}
            <span className="text-effectColor">desire</span> , the{" "}
            <span className="text-effectColor">passion</span> and the ability to{" "}
            <span className="text-effectColor">learn quickly</span>.
          </p>
      ...
      <RightMotion>
        <div className="relative w-[250px] h-[250px] lg:w-[350px] lg:h-[350px] my-10 md:mb-10 md:mt-0 rounded-xl shadow-lg shadow-shadowColor hover:scale-[1.03] transition ease-linear duration-150 self-center">
          <Image
