  ...
  return (
    <div>
        ...
        <div className='relative shadow-xl shadow-shadowColor'>
            <img className='h-[350px] w-full opacity-30' src='portfolio.png' alt=""/>
            ...
            <div className='md:w-[50%]'>
                ...
                <div className='mt-4'>
                    <button className='uppercase text-white mr-4 px-5 py-2 hover:scale-[1.1]'>
                        <Link href="https://portfolio-omega-seven-47.vercel.app/">
                            demo                        
                        </Link>
                    </button>

                    <button className='uppercase text-white px-5 py-2 hover:scale-[1.1]'>
                        <Link href="https://github.com/Marella-Rahal/Portfolio">
                            code
                        </Link>
                    </button>
